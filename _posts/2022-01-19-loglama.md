...
![](https://endrcn.dev/wp-content/uploads/2022/01/Screen-Shot-2022-01-15-at-02.13.34.png)

console.error(new Error("There is an error"));

![](https://endrcn.dev/wp-content/uploads/2022/01/Screen-Shot-2022-01-15-at-02.14.55.png)
...
![](https://endrcn.dev/wp-content/uploads/2022/01/Screen-Shot-2022-01-15-at-02.16.23.png)
...
![](https://endrcn.dev/wp-content/uploads/2022/01/Screen-Shot-2022-01-15-at-02.17.50.png)

### console.table(json)

Bir JSON verisini tablo olarak gösterebilmemizi sağlar.

![](https://endrcn.dev/wp-content/uploads/2022/01/Screen-Shot-2022-01-15-at-02.21.10.png)
...
![](https://endrcn.dev/wp-content/uploads/2022/01/Screen-Shot-2022-01-19-at-00.06.38.png)

Loglama Proje Yapısı
...
const customFormat = format.printf(info => \`${info.timestamp} ${info.level.toUpperCase()}: \[userid:${info.message.userId}\] \[ip\_addr:${info.message.ipAddr}\] \[location:${info.message.location}\] \[procType:${info.message.procType}\] \[log:${JSON.stringify(info.message.log)}\]\`);
...
![](https://endrcn.dev/wp-content/uploads/2022/01/Screen-Shot-2022-01-20-at-00.11.27-1024x39.png)
...
![](https://endrcn.dev/wp-content/uploads/2022/01/Screen-Shot-2022-01-20-at-00.31.31-1024x249.png)

Loglama sınıfı metot imzası

Son olarak çıktımızı da görelim:

![](https://endrcn.dev/wp-content/uploads/2022/01/Screen-Shot-2022-01-20-at-00.34.20-1024x35.png)
