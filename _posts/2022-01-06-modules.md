...
Bu komut çalıştırıldığında, projenin ana dizininde **node\_modules** adında bir klasör oluşturulur ve **request** isimli modülün dosyaları bu klasörün altına kaydedilir.
