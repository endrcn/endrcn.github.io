...
![_config.yml]({{ site.baseurl }}/images/regex1)
...
ifadeleri yakala. Bu eşleşmeye uyan metnin içinde geçen suluk, silik, salık, salak,s\_l\_k,s l k gibi ifadelerin tamamı yakalanır. Ayrıca asalak, isilik, asilik, sulukçu, sulukule gibi ifadeler de bir parçası eşleşen ifadeler de yakalanır. Ancak burada dikkat edilmesi gereken kısım, sadece tanımladığımız parçanın eşleşeceğidir.

![_config.yml]({{ site.baseurl }}/images/regex2)
...
![_config.yml]({{ site.baseurl }}/images/regex3-1)
...
![_config.yml]({{ site.baseurl }}/images/regex4)
...
![Regex - + karakteri](https://endrcn.dev/wp-content/uploads/2022/01/regex5)
...
![Regex - * Karakteri](https://endrcn.dev/wp-content/uploads/2022/01/regex6)
...
![Regex - ? karakteri](https://endrcn.dev/wp-content/uploads/2022/01/regex7)
...
![Regex - {n,m} karakteri](https://endrcn.dev/wp-content/uploads/2022/01/regex8)
...
![Regex - {n} karakteri](https://endrcn.dev/wp-content/uploads/2022/01/regex9)
...
![Regex - ^ karakteri](https://endrcn.dev/wp-content/uploads/2022/01/regex10)
...
![Regex - \[^...\] kullanımı](https://endrcn.dev/wp-content/uploads/2022/01/regex11)
...
![Regex - \\ karakteri](https://endrcn.dev/wp-content/uploads/2022/01/regex12)
...
![Regex - () kullanımı](https://endrcn.dev/wp-content/uploads/2022/01/regex13)
...
![Regex - $ karakteri](https://endrcn.dev/wp-content/uploads/2022/01/regex14)
